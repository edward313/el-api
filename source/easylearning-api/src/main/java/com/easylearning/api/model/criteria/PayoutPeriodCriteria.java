...
@Data
public class PayoutPeriodCriteria {
    private Long id;
    ...
    public Specification<MonthlyPeriod> getSpecification() {
        return new Specification<MonthlyPeriod>() {
            private static final long serialVersionUID = 1L;

            @Override
            public Predicate toPredicate(Root<MonthlyPeriod> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                ...
                if (getSystemRevenue() != null) {
                    predicates.add(cb.equal(root.get("systemRevenue"), getSystemRevenue()));
                }
